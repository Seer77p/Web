...
// const num1 = Number.parseInt(prompt("Ввести первое число"));
// const num2 = +prompt("Ввести dnjhjt число");
...
// const answerQuestion = confirm("Вам хорошо живется?")
// if (answerQuestion) { alert('Тогда мы идем к вам'); }
...
// const product = prompt("Введитк продукт:").toLowerCase();
...
//необходимо реализовать функцию так, чтобы она возвращала значение
