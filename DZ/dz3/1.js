...
const velue_Celcy = +prompt("Ввведите температуру в градусах:");

function translate_faringate(velue_Celcy) {
    return (9 / 5) * velue_Celcy + 32;
}

alert(`\nВы ввели ${velue_Celcy} градусов цельсия,\nа в Фарингейтах будет: ${(translate_faringate(velue_Celcy)).toFixed(2)}`);